...
public class Ui {
    ...
    public void printReinputMessageOpenOption() {
        System.out.println(REINPUT_MESSAGE_OPEN_OPTION);
    }

    public void printReinputMessageSearchMethod() {
        System.out.println(REINPUT_MESSAGE_SEARCH_METHOD);
    }
